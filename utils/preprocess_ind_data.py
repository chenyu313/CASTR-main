...
logging.basicConfig(
    ...
    level=logging.DEBUG,
    filename='logs/preprocess_ind_data.log',
    filemode='a')
...
if __name__ == '__main__':
    ...
    raw_test = os.path.join(os.getcwd(), 'dataset', args.task, 'test.txt')
    raw_valid = os.path.join(os.getcwd(), 'dataset', args.task, 'valid.txt')
